...
use Lujihong\ImageHash\Implementations\AverageHash;
use Lujihong\ImageHash\Implementations\BlockHash;
use Lujihong\ImageHash\Implementations\DifferenceHash;
use Lujihong\ImageHash\Implementations\PerceptualHash;
